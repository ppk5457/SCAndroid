    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Uri uri=Uri.parse("content://cn.edu.sc.scu.mywordsprovider");
                Cursor cursor=null;
                if(TextUtils.isEmpty(word)){
                    //uri=Uri.parse("content://cn.edu.sc.scu.mywordsprovider/words");
                    cursor=contentResolver.query(uri,new String[]{"_id","word","mean"},null,null,null);
                }else{
                    //uri=Uri.withAppendedPath(Uri.parse("content://cn.edu.sc.scu.mywordsprovider"),"/word/"+word);
                    cursor=contentResolver.query(uri,new String[]{"_id","word","mean"},"word=?",new String[]{word},null);
                }
                adapter=new SimpleCursorAdapter(MyWordListActivity.this,R.layout.item_word,cursor,new String[]{"word","mean"},new int[]{R.id.txtWord,R.id.txtMean});
